...
import { getTeamMembers, createTeamMember, updateTeamMember, reorderTeam, deleteTeamMember } from '../controllers/team.controller.js';
...
router.put('/reorder', protect, admin, reorderTeam);
