      ...
      <ScrollReveal>
        ...
        <div className="filters-bar">
          ...
          <div className="status-toggle">
            ...
            <button className={statusFilter === 'past' ? 'active' : ''} onClick={() => setStatusFilter('past')}>Past</button>
          </div>
        </div>
        ...
        {filteredEvents.length > 0 && (
          <div className="load-more">
            <p className="showing-text">Showing {filteredEvents.length} of {events.length} activities</p>
            <div className="progress-bar"><div className="progress-fill" style={{ width: `${(filteredEvents.length / events.length) * 100}%` }} /></div>
            <button className="btn btn-outline" style={{ marginTop: '2rem' }}>Load More Events</button>
          </div>
        )}
      </ScrollReveal>
    </div>
